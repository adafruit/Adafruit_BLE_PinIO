...
class BLEFirmataClass
{
public:
    BLEFirmataClass();
/* Arduino constructors */
    void begin(Adafruit_BLE_UART &ble_uart);
/* querying functions */
...
private:
    ...
    Adafruit_BLE_UART *uart; // Replace UART Stream with Adafruit_BLE_Serial
...
extern BLEFirmataClass Firmata;
